              ...
              m.channel.awaitMessages( m1 => m1.author == message.author,{ maxMatches: 1, time: 60*1000 } ).then ( (m1) => {
                  ...
                  m.edit(message.member + ', **:timer:**').then( (m) =>{
                      ...
                      m.edit(message.member + ', **....جارى جمع البيانات**').then( (mtime)=>{
                        ...
                        .addField('**`كم ايديك بالسيرفر✍`**', `${name}` , true)
                        .addField('**`- تعريف الحياة الواقعية - Roleplay :`**', `${age}` , true)
                        .addField('**`- تعريف تقدير الحياة (LAR):`**',`${ask}`)
                        .addField('**`- الفتل العشوائي - ( RDM ):`**',`${ask2}`)
                        .addField('**`- الصدم العشوائي - ( VDM ):`**',`${ask3}`)
